...
const validationMethods = {
  ...
  shopName(shopName) {
    ...
    const nameExist = Accounts.find({
      "profile.vendorDetails.[0].shopName": shopName
    }).fetch();
    if (nameExist.length > 0) {
      // Invalid
      return {
        error: "INVALID_SHOPNAME",
        reason: "This shop name already exists",
        i18nKeyReason: "Shop name already exists"
      };
    }
    ...
    return {
      error: "INVALID_SHOPNAME",
      reason: "The Shop Name has to be a maximum of 20 characters and does not accept special characters",
      i18nKeyReason: "The Shop Name has to be a maximum of 20 characters and does not accept special characters"
    };
  },
